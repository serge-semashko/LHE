...
function getAllData() {
    ...
    //
    //    $.getJSON("http://nucloweb.jinr.ru/kgu/Cache/get_data.php?callback=?", function (t) {
    //        //    $.getJSON("http://127.0.0.1:9090/get_data.php?callback=?", function (t) {
    //        processData(t);
    //
    //    })
//      var url = "/get_data.php?callback=?";
//    var url = "http://10.0.10.103:9090/get_data=1&callback=?";
//    var url = "http://10.0.10.103/get_data.php?callback=?";
...
function saveCookie(name,value) {
  document.cookie = "tessss=value;path=/;";
}
function ch2modechange() {
    chupdating[2] = true;
    //    document.getElementById("ch2select").disabled = true;
...
function ch2_1periodchange() {
    ...
    chupdating[2] = true;
    var selnum = document.getElementById().options.selectedIndex;
    var needlen = 120;
    switch (selnum) {
        case 0:
            needlen = 120;
    ...
    updateChart(chartData2_1, chart2_1, needlen);
}
function ch2_2periodchange() {
    ...
    chupdating[2] = true;
    //    document.getElementById("ch2select").disabled = true;
    var selnum = document.getElementById("ch2_2periodselect").options.selectedIndex;
    var needlen = 120;
    switch (selnum) {
        case 0:
            needlen = 120;
    ...
    updateChart(chartData2_2, chart2_2, needlen);
}
...
function ch3periodchange() {
    ...
    chupdating[2] = true;
    //    document.getElementById("ch2select").disabled = true;
    var selnum = document.getElementById("ch3periodselect").options.selectedIndex;
    var needlen = 120;
    switch (selnum) {
        case 0:
            needlen = 120;
    ...
    updateChart(chartData3, chart3, needlen);
...
function ch3_1periodchange() {
    ...
    chupdating[2] = true;
    //    document.getElementById("ch2select").disabled = true;
    var selnum = document.getElementById("ch3_1periodselect").options.selectedIndex;
    var needlen = 120;
    switch (selnum) {
        case 0:
            needlen = 120;
    ...
    updateChart(chartData3_1, chart3_1, needlen);
...
function ch3_2periodchange() {
    ...
    chupdating[2] = true;
    //    document.getElementById("ch2select").disabled = true;
    var selnum = document.getElementById("ch3_2periodselect").options.selectedIndex;
    var needlen = 120;
    switch (selnum) {
        case 0:
            needlen = 120;
    ...
    updateChart(chartData3_2, chart3_2, needlen);
...
function updateChart(chartD, chart, serlen) {
    var url = "http://10.0.10.103:9090/get_hist=1&callback=?";
    //console.log("\n###Agetson nucloweb start");
    $.ajax({
        type: "POST",
        dataType: "json",
