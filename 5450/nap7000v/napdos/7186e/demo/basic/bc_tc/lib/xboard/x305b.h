...
void X305B_SetDelay(int X305B_AiChannelDelayTime);
/* Delay time range: 0ms~20ms  , Delay Unit: 0.01ms */

int X305B_GetDelay(void); //Unit: 0.01ms
...
void X305B_AnanlogInSetChannel(int iChannel);
int X305B_AnalogInHex(int iChannel);
float X305B_AnalogInHexToFloat(int iValue);
