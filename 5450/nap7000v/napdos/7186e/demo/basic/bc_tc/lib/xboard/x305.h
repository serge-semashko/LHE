...
#define X305_SetAdChannel(Channel,X305_iMem_DO) outp(0, ((Channel)<<4)|X305_iMem_DO)
...
void X305_SetDelay(int X305_AiChannelDelayTime);
/* Delay time range: 0ms~20ms  , Delay Unit: 0.01ms */

int X305_GetDelay(void); //Unit: 0.01ms

int X305_AnalogInHex(int iChannel);
float X305_AnalogInHexToFloat(int iValue);

int X305_AnalogIn_no(int iChannel,unsigned no);
/* no: 1~32767  */
